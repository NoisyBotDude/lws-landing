          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              <div className="flex items-center">
                ...
                <a href="https://calendly.com/admin-learnwithstack/30min" className="text-gray-300 hover:text-[#8B5CF6]">
                  Book an appointment
                </a>
              </div>
              <div className="flex items-center">
                <EnvelopeIcon className="h-5 w-5 text-[#8B5CF6] mr-2" />
                <a href="mailto:support@example.com" className="text-gray-300 hover:text-[#8B5CF6]">
