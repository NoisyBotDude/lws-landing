...
export default function BlogList() {
    ...
    return (
        <>
            <Helmet>
                <title>All Blogs | Build With Stack</title>
                <meta name="description" content="Explore all blogs, insights, and tutorials from Build With Stack." />
                <meta property="og:title" content="All Blogs | Build With Stack" />
                <meta property="og:description" content="Explore our latest blog posts, case studies, and insights." />
                <meta property="og:type" content="website" />
                <link rel="canonical" href="https://buildwithstack.com/blogs/all" />
            </Helmet>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            ...
                            {categories.map((category) => (
                                <button
                                    ...
                                    className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${selectedCategory === category._id
                                        ? 'bg-[#8B5CF6] text-white shadow-lg shadow-[#8B5CF6]/30'
                                        : 'bg-white/5 text-gray-300 border border-white/10 hover:bg-white/10 hover:border-[#8B5CF6]/30'
                                        }`}
                                >
