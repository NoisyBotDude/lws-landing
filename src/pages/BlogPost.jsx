...
export default function BlogPost() {
    ...
    return (
        <>
            {post && (
                <Helmet>
                    <title>{post?.title ? `${post.title} | Build With Stack` : 'Loading Blog...'}</title>
                    <meta name="description" content={post?.excerpt || `Read ${post?.title || 'our latest blog'} on Build With Stack.`} />
                    <meta property="og:title" content={post?.title || 'Blog Post'} />
                    <meta property="og:description" content={post?.excerpt || 'Explore blogs and insights from Build With Stack.'} />
                    <meta property="og:image" content={post?.mainImage?.asset?.url || '/default-image.jpg'} />
                    <meta property="og:type" content="article" />
                    <link rel="canonical" href={`https://buildwithstack.com/blogs/blog/${slug}`} />
                    <script type="application/ld+json">
                        {JSON.stringify({
                            ...
                            author: {
                                "@type": "Person",
                                name: post?.author?.name || "Build With Stack",
                            },
                            publisher: {
                                "@type": "Organization",
                                ...
                                logo: {
                                    "@type": "ImageObject",
                                    url: "https://buildwithstack.com/logo.png",
                                },
                            },
                            mainEntityOfPage: {
                                "@type": "WebPage",
                                "@id": `https://buildwithstack.com/blogs/blog/${slug}`,
                            },
